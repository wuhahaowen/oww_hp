/**
 * Script to generate SVG sprites at build time
 * This reduces HTTP requests by combining multiple SVGs into sprite sheets
 */
...
const CONFIG_FILE = path.join(__dirname, '../src/common/json.js');
...
const configModule = require('../src/common/json.js');
const iconConfig = configModule.iconConfig || configModule.default || [];
