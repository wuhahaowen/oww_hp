...
// 更新状态
    ...
    return (
        ...
        >
            ...
            <div className="3d_viewer" style={{
                width: "100%",
                height: "100%",
                background: "var(--luhun-back-color)",
                position: "fixed",
                 zIndex: 10,
                 // 通过flex布局确保内容垂直居中
                // display: "flex",
            ...
            >
                ...
                {/*    onToggleAllLights={toggleAllLights} // 添加灯光控制函数*/}
                {/*    onControlAllCurtains={controlAllCurtains} // 添加窗帘控制函数*/}
                {/*/>*/}
